...
const Projects = ({ title, srcImg, description, logoDev = [], logoAcces = [] }) => {
    return (
        ...
        <aside className='flex flex-col  rounded-sm lg:w-1/3 bordure'>
            <figure className=' rounded-sm min-h-full w-full flex flex-col justify-evenly items-center gap-2'>

                {/* Image principale du projet */}
                <Image className='object-cover max-h-60 w-full p-2 rounded-xl  backdrop-blur-sm' src={srcImg} width={100} height={100} alt={title} />
